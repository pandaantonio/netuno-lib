...
export default class CanvasUtil {
  ...
  static motionBlur(ctx: CanvasRenderingContext2D, image: Canvas, x: number, y: number, width: number, height: number) {
  ...
  static centerImage(base: Canvas, data: Canvas) {
